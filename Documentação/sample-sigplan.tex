...
No artigo\cite{8567098} os autores relatam as diferentes entre as criptomoedas e as Moedas Fiat com a amostragem das Arquiteturas de cada um , o Algoritmo, Fluxo de caixa e principalmente a Economia primeira diferença mostrado por elas são o modelo da Arquitetura no qual a Moeda Fiat evidenciada pelos cartões de credito realizam  uma transação que e rastreada da sua origem para o destino já as Criptomoedas já foram projetadas para não ser possível identificar a origem e nem os rastreio das mesmas.
Com isso os Autores irão descrevendo as técnicas que utilizaram no decorrer do artigo as principais diferenças entre os dois tipos de moedas e como elas afetam a economia de casa países que as utilizam e por fim o aval na qual moedas os altores acham melhor a utilização e como eles encheram essas moedas no futuro
%-----------------------------------------------------------
