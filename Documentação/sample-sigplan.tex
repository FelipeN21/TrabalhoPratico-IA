...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{ibagens/output.png}
  \caption{Predição do preço bitcoin}
  \Description{phisical bitcoin.}
\end{figure}

\subsection{Gráfico Predição do preço bitcion}

No gráfico em questão temos representado pela linha vermelha a predicao do bitcion (no qual foi utilizado o algoritimo de regressao Arima), e a linha azul representando o preço real do mesmo ao passar do tempo. No inicio percebemos que as duas linhas estao uniformemente juntas mas em um certo momento elas se distancião causando assim um erro. Com isso nosso proximo foco sera ajustar nossos pre-processamentos para chegarmos em um grau de erro menor.
